...
@section('title', 'AICS - Caloocan City Social Services')

@section('content')
<!-- Hero Section -->
<section class="relative overflow-hidden bg-gradient-to-br from-caloocan-primary to-caloocan-secondary">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="text-center">
            ...
            <h1 class="text-5xl font-bold text-white mb-6">AICS</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-6">About AICS</h2>
                    <p class="text-lg text-gray-600 mb-6">
                        The Assistance to Individuals in Crisis Situation (AICS) is a program designed to provide immediate financial assistance to individuals and families facing crisis situations. This program aims to help Caloocan City residents overcome temporary difficulties and get back on their feet.
                    </p>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div class="bg-caloocan-primary/10 p-6 rounded-xl">
                            <h3 class="text-xl font-semibold text-caloocan-primary mb-3">Medical Assistance</h3>
                            <p class="text-gray-700">Financial support for medical expenses, hospitalization, and medication costs.</p>
                        </div>
                        <div class="bg-caloocan-secondary/10 p-6 rounded-xl">
                            <h3 class="text-xl font-semibold text-caloocan-secondary mb-3">Burial Assistance</h3>
                            <p class="text-gray-700">Support for funeral and burial expenses during times of loss.</p>
                        </div>
                        <div class="bg-caloocan-accent/10 p-6 rounded-xl">
                            <h3 class="text-xl font-semibold text-caloocan-accent mb-3">Educational Assistance</h3>
                            <p class="text-gray-700">Help with school fees, supplies, and other educational expenses.</p>
                        </div>
                        <div class="bg-caloocan-gold/10 p-6 rounded-xl">
                            <h3 class="text-xl font-semibold text-caloocan-gold mb-3">Transportation Assistance</h3>
                            <p class="text-gray-700">Support for emergency travel and transportation needs.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Any government-issued ID (SSS, GSIS, Driver's License, etc.)</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Proof of Crisis</h3>
                                <p class="text-gray-600">Medical certificate, death certificate, or other relevant documents</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Income Certificate</h3>
                                <p class="text-gray-600">Certificate of income or indigency from barangay</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="text-xl font-semibold text-gray-900 mb-2">Submit Requirements</h3>
                                <p class="text-gray-600">Complete all required documents and submit them to the Social Services Office.</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="text-xl font-semibold text-gray-900 mb-2">Assessment</h3>
                                <p class="text-gray-600">Your application will be reviewed and assessed by our social workers.</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="w-12 h-12 bg-gradient-to-br from-caloocan-accent to-caloocan-gold rounded-full flex items-center justify-center mr-6">
                                <span class="text-white font-bold">3</span>
                            </div>
                            <div>
                                <h3 class="text-xl font-semibold text-gray-900 mb-2">Approval</h3>
                                <p class="text-gray-600">Once approved, you will be notified and assistance will be provided.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Contact AICS Office</h3>
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-caloocan-primary mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                            </svg>
                            <span class="text-gray-700">Caloocan City Hall, Ground Floor</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-caloocan-primary mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700">aics@caloocan.gov.ph</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Quick Actions -->
                <div class="bg-gradient-to-br from-caloocan-primary to-caloocan-secondary rounded-2xl p-6 text-white">
                    <h3 class="text-xl font-bold mb-4">Need Immediate Help?</h3>
                    <p class="mb-4 text-white/90">For emergency situations, we provide expedited processing.</p>
                    <a href="tel:+6328XXXXXXX" class="block w-full bg-white text-caloocan-primary text-center py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                        📞 Emergency Hotline
                    </a>
                </div>
            </div>
