...
@section('title', 'PDAO - Caloocan City Social Services')

@section('content')
<!-- Hero Section -->
<section class="relative overflow-hidden bg-gradient-to-br from-caloocan-accent to-caloocan-gold">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="text-center">
            ...
            <h1 class="text-5xl font-bold text-white mb-6">PDAO</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-6">About PDAO</h2>
                    <p class="text-lg text-gray-600 mb-6">
                        The Persons with Disability Affairs Office (PDAO) is committed to promoting the rights, welfare, and development of persons with disabilities in Caloocan City. We provide comprehensive services to ensure equal opportunities and full participation in society.
                    </p>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div class="bg-caloocan-accent/10 p-6 rounded-xl">
                            <h3 class="text-xl font-semibold text-caloocan-accent mb-3">PWD ID Application</h3>
                            <p class="text-gray-700">Application and renewal of Persons with Disability identification cards.</p>
                        </div>
                        <div class="bg-caloocan-gold/10 p-6 rounded-xl">
                            <h3 class="text-xl font-semibold text-caloocan-gold mb-3">Assistive Devices</h3>
                            <p class="text-gray-700">Provision of wheelchairs, hearing aids, and other assistive devices.</p>
                        </div>
                        <div class="bg-caloocan-orange/10 p-6 rounded-xl">
                            <h3 class="text-xl font-semibold text-caloocan-orange mb-3">Skills Training</h3>
                            <p class="text-gray-700">Vocational training and skills development programs.</p>
                        </div>
                        <div class="bg-caloocan-primary/10 p-6 rounded-xl">
                            <h3 class="text-xl font-semibold text-caloocan-primary mb-3">Advocacy & Support</h3>
                            <p class="text-gray-700">Rights advocacy, counseling, and community support services.</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Benefits Section -->
                <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-6">PWD Benefits & Privileges</h2>
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Exemption from Value Added Tax on certain purchases and services</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Scholarship programs and educational support for PWDs</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-6">Requirements for PWD ID</h2>
                    <div class="space-y-4">
                        <div class="flex items-start">
                            <div class="w-6 h-6 bg-caloocan-accent rounded-full flex items-center justify-center mr-4 mt-1">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Medical Certificate</h3>
                                <p class="text-gray-600">Medical certificate from a licensed physician indicating the type and degree of disability</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="w-6 h-6 bg-caloocan-gold rounded-full flex items-center justify-center mr-4 mt-1">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Contact PDAO Office</h3>
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-caloocan-accent mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                            </svg>
                            <span class="text-gray-700">Caloocan City Hall, 3rd Floor</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-caloocan-accent mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700">pdao@caloocan.gov.ph</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Quick Actions -->
                <div class="bg-gradient-to-br from-caloocan-accent to-caloocan-gold rounded-2xl p-6 text-white">
                    <h3 class="text-xl font-bold mb-4">Get Support</h3>
                    <p class="mb-4 text-white/90">Our team is here to help you access the services and support you need.</p>
                    <a href="tel:+6328XXXXXXX" class="block w-full bg-white text-caloocan-accent text-center py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                        📞 Call PDAO Office
                    </a>
                </div>
            </div>
